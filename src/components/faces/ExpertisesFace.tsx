        ...
        <div className="mb-14 pb-8 border-b border-[#e2dcd2]">
          <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-sm font-medium">
            ...
            <div className="relative">
              ...
              {openDropdown === 'domain' && (
                <div className="absolute left-0 mt-2 w-60 max-w-[calc(100vw-2.5rem)] bg-white border border-slate-200 shadow-xl py-2 z-30 animate-in fade-in zoom-in-95 duration-100">
