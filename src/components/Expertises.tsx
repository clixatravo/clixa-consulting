  ...
  return (
    <section id="expertises" className="py-24 bg-[#050811] relative scroll-mt-24 overflow-hidden border-b border-white/[0.08]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {/* SQLI-Style Split Layout: Left Overview & Right Interactive List/Dossier */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          
          {/* Left Column: Fixed / Sticky Editorial Briefing (SQLI Push-Services Style) */}
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-slate-800 text-xs font-semibold text-sky-400 shadow-sm">
              ...
              <span className="font-heading uppercase tracking-wider text-[11px]">Expertises & Systèmes d'Information</span>
            </div>

            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight font-heading">
              Nos Domaines d'Excellence Stratégique
            </h2>

            <p className="text-sm sm:text-base text-slate-300 font-sans leading-relaxed">
              Nous combinons vision métier, rigueur financière et maîtrise technologique de terrain pour accélérer votre croissance et fiabiliser durablement vos opérations.
            </p>
            ...
            <div className="pt-2">
              <button
                ...
                className="link-cta-sqli"
              >
                <span>Cadrer votre projet avec un associé</span>
            ...
            <div className="pt-6 border-t border-white/[0.08] space-y-3">
              ...
              <div className="flex items-center gap-2.5 text-xs text-slate-300">
                ...
                <span>Intervention sous 72h au Maroc et en France</span>
              </div>
            </div>
          </div>

          {/* Right Column: Interactive Capability Cards / Dossier */}
          <div className="lg:col-span-7 space-y-4">
            
            {/* Nav Switcher Accordion Items */}
                      ...
                      <div className="flex items-center gap-3.5">
                        ...
                        <div>
                          <div className="text-[10px] font-mono text-slate-500 uppercase">
                            PÔLE 0{idx + 1} {exp.isFlagship && "• OFFRE PHARE"}
                          </div>
                        ...
                        <div className="pt-4 space-y-4">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                              {exp.items.map((item, iIdx) => (
                                <div
                                  key={iIdx}
                                  className="flex items-start gap-2 p-2 rounded-lg bg-slate-950/80 border border-white/[0.05] text-xs text-slate-300"
                                >
                          ...
                          <div className="pt-3">
                            <button
                              ...
                              className="executive-btn-primary w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-xs sm:text-sm font-bold text-white font-heading"
                            >
