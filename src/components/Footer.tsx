        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-850">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              ...
              <li>
                <a href="#pourquoi" className="hover:text-sky-400 transition-colors">Pourquoi CLIXA ?</a>
              </li>
              <li>
                <a href="#pourquoi" className="hover:text-sky-400 transition-colors">Approche Hybride</a>
              </li>
              <li>
