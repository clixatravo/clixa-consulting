...
import { ArrowUpRight, ArrowDown, Sparkles, ChevronRight, ShieldCheck, CheckCircle2, Star, ArrowRight } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({ onOpenConsultation }) => {
  ...
  return (
    <section id="accueil" className="relative min-h-[92vh] flex flex-col justify-center pt-32 sm:pt-40 pb-20 sm:pb-28 overflow-hidden bg-[#050811] scroll-mt-24">
      {/* SQLI-Style Ambient Cinematic Lighting & Depth */}
      <div className="absolute inset-0 bg-executive-grid opacity-25 pointer-events-none" />
      <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[1250px] h-[650px] bg-gradient-to-b from-sky-500/12 via-blue-600/6 to-transparent blur-[160px] rounded-full pointer-events-none transform-gpu animate-pulse-glow" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex-1 flex flex-col justify-center">
        ...
        {/* Primary Executive Title - Grand & Authoritative (SQLI Tone) */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[76px] font-extrabold tracking-tight text-white leading-[1.1] mb-6 font-heading max-w-5xl mx-auto animate-entrance-up">
        ...
        {/* Subtitle - Breathable & High-Impact */}
        ...
        {/* SQLI-Style Action Suite */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 max-w-md sm:max-w-none mx-auto">
          <button
            onClick={() => onOpenConsultation()}
            className="executive-btn-primary w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl text-sm sm:text-base font-bold text-white transition-all active:scale-[0.98] cursor-pointer border border-sky-400/30 font-heading group"
          >
        ...
        {/* SQLI-Style Showcase: The 3 Core Strategic Pillars */}
          ...
          <div className="flex items-center justify-between mb-6 px-1">
            <div>
              <span className="text-xs font-mono font-bold uppercase tracking-wider text-sky-400 flex items-center gap-2">
                ...
                Pôles d'Excellence & Réalisations
              </span>
              <p className="text-xs text-slate-400 mt-1">
                Pilotés directement par des associés séniors issus des grands cabinets de conseil
              </p>
            </div>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t border-white/[0.06] flex items-center justify-between text-xs font-semibold text-sky-400 group-hover:text-sky-300 font-heading">
                    ...
                    <div className="w-5 h-5 rounded-full bg-sky-500/10 flex items-center justify-center group-hover:bg-sky-500 group-hover:text-white transition-all">
