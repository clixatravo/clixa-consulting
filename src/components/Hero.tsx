  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-24 sm:pt-32 pb-16 sm:pb-20 overflow-hidden bg-slate-950">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-5 mb-12 sm:mb-16 text-xs sm:text-sm text-slate-400">
          <a
            href={`tel:${BRAND.phoneMarocRaw}`}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-900/60 border border-slate-800 hover:border-sky-500/50 hover:text-white transition-all"
          >
            <span>🇲🇦</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
            {CORE_PILLARS.map((pillar) => (
              <div
                ...
                className="rounded-2xl bg-slate-900/80 border border-slate-800 hover:border-sky-500/50 hover:bg-slate-900 transition-all duration-300 shadow-xl group cursor-pointer flex flex-col justify-between overflow-hidden"
              >
                ...
                <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs font-medium text-slate-300 mb-2.5 sm:mb-3">
                      {pillar.subtitle}
                    </p>
